(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    ...
    global.LegalContent = mod.exports;
  }
  ...
  var LegalContentRecord = new _immutable.Record({
    type: null,
    content: null,
    mandatory: false,
  ...
  var LegalContent = function (_LegalContentRecord) {
    _inherits(LegalContent, _LegalContentRecord);

    function LegalContent(image) {
      _classCallCheck(this, LegalContent);
