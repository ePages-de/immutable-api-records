(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', './Attachment', './Cart', './DiscountOrFee', './Image', './Link', './PageableContainer', './PaymentMethod', './Price', './Product', './ProductAttribute', './ProductAttributeDefinition', './ProductIdentifier', './Quantity', './ShippingMethod', './Shop'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('./Attachment'), require('./Cart'), require('./DiscountOrFee'), require('./Image'), require('./Link'), require('./PageableContainer'), require('./PaymentMethod'), require('./Price'), require('./Product'), require('./ProductAttribute'), require('./ProductAttributeDefinition'), require('./ProductIdentifier'), require('./Quantity'), require('./ShippingMethod'), require('./Shop'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.Attachment, global.Cart, global.DiscountOrFee, global.Image, global.Link, global.PageableContainer, global.PaymentMethod, global.Price, global.Product, global.ProductAttribute, global.ProductAttributeDefinition, global.ProductIdentifier, global.Quantity, global.ShippingMethod, global.Shop);
    global.index = mod.exports;
  }
})(this, function (exports, _Attachment, _Cart, _DiscountOrFee, _Image, _Link, _PageableContainer, _PaymentMethod, _Price, _Product, _ProductAttribute, _ProductAttributeDefinition, _ProductIdentifier, _Quantity, _ShippingMethod, _Shop) {
  'use strict';
